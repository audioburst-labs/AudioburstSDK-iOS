...
install_xcframework "${PODS_ROOT}/AudioburstMobileLibrary/AudioburstMobileLibrary.xcframework" "AudioburstMobileLibrary" "framework" "ios-x86_64-simulator" "ios-arm64"
