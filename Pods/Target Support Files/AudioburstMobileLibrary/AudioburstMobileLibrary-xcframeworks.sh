...
install_xcframework "${PODS_ROOT}/AudioburstMobileLibrary/AudioburstMobileLibrary.xcframework" "AudioburstMobileLibrary" "framework" "ios-arm64" "ios-x86_64-simulator"
